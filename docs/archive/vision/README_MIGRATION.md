...
`backend/games/<game_id>/manifest.json` 的 `vision_profile` 节点中声明；游戏视频 path
由该节点管理，部署级 WebRTC 基础地址由 `vision/yolov8_adjudicator/config.json`
管理。详细协议见当前 runtime 说明 `vision/yolov8_adjudicator/README.md`。
