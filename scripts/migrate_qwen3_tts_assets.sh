...
SOURCE_ROOT="${QWEN3_TTS_SOURCE:-/home/spacemit/projects/qwen3-tts}"
...
[[ -d "$SOURCE_ROOT" ]] || { echo "Source does not exist: $SOURCE_ROOT" >&2; exit 1; }
...
speaker_file="$(python3 - "$SOURCE_ROOT/qwen3-tts-0.6b/config.json" <<'PY'
import json
import sys
