...
from components.vision_yolov8_objdetect.provider import _consume_legacy_log_line  # noqa: E402
...
class ComponentTests(unittest.TestCase):
    ...
    def test_registry_loads_packaged_providers(self):
        ...
        self.assertEqual(
            registry.get_manifest("vision_yolov8_objdetect")["entry"],
            "provider.py:VisionYolov8Objdetect",
        )
